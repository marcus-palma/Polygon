## Description
**Polygon** is a C++ CLI tool with a simple interpreter and dynamic file loading to enable easy creation and usage of geometric shape area calculations.
